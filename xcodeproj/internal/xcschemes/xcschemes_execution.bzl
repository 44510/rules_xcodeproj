...
def _write_schemes(
    ...
    for info in xcscheme_infos:
        ...
        custom_scheme_args.add(info.test.env_include_default)
        ...
        custom_scheme_args.add(info.run.env_include_default)
        ...
        custom_scheme_args.add(info.profile.env_include_default)
